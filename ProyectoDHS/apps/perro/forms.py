...
class FormularioPerro(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = { 
            ...
            'id_dieta': forms.Select(attrs={'class':'form-control'}),
            'id_nivel_entrenamiento': forms.Select(attrs={'class':'form-control'}),
            'id_padre': forms.Select(attrs={'class':'form-control'}),
            'id_madre': forms.Select(attrs={'class':'form-control'}),
